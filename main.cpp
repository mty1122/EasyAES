...
int main() {
    //Base64 test
    auto code = eaes::base64_encode((const unsigned char*)"hello c++ !", strlen("hello c++ !"));
    auto text = eaes::base64_decode_to_string(code.get());
    cout << "base64 test:" << endl << code.get() << endl << text << endl;
